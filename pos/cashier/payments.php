...
if (isset($_GET['cancel'])) {
    $id = $_GET['cancel'];
    $adn = "DELETE FROM  penjualan  WHERE  PenjualanID = ?";
                    ...
                    <div class="card shadow">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    <?php
                                    $ret = "SELECT * FROM  penjualan WHERE status =''  ORDER BY `penjualan`.`DibuatPada` DESC  ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="pay_order.php?kode_penjualan=<?php echo $order->kode_penjualan;?>&PelangganID=<?php echo $order->PelangganID;?>&status=Bayar">
                                                ...
                                                <a href="payments.php?cancel=<?php echo $order->PenjualanID; ?>">
