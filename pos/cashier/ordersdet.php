...
$Username = $userInfo['Username'];
                    ...
                    <tr>
                        ...
                        <td class="px-3"><?= $dtpelanggan['NamaPelanggan'] ?></td>
                        ...
                        <td align="right">
                            ...
                            <a href="detail_penjualan.php?penid=<?= $data['penjualan_id'] ?>&npet=<?= $dtpetugas['Username'] ?>&npel=<?= $dtpelanggan['NamaPelanggan'] ?>&tgl=<?= $data['tanggal'] ?>&byr=<?= $byr ?>&kbl=<?= $kbl ?>&halaman=<?= $halaman ?>" class="btn btn-danger btn-sm">Detail</a>
                        </td>
                    </tr>
